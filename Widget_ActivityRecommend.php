<?php
 class Widget_ActivityRecommend extends WP_Widget {
 	function Widget_ActivityRecommend() 
 	{
		$widget_ops = array('description' => __('Faceboook Activity Widget', 'sjworkspaces'));
		$this->WP_Widget('ActivityRecommend', __('Facebook Activity'), $widget_ops);
 	...
 	function widget($args, $instance) {
		...
		echo '<fb:activity bordercolor="'.$bordercolor.'" colorscheme="'.$colorscheme.'" recommendations="'.$recommTxt.'" height="'.$height.'" width="'.$width.'" header="'.$header.'" site="'.$site.'"></fb:activity>';
...
add_action('widgets_init', 'widget_ActivityRecommend_init');
function widget_ActivityRecommend_init() {
	register_widget('Widget_ActivityRecommend');
}
